...
public class BookAddCopyDTO {
    ...
    @Schema(description = "ID книги, для которой добавляются копии", example = "10", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "ID обновляемой копии не может быть равен нулю")
    private Integer bookId;

    @Schema(description = "Количество копий для добавления", example = "5", requiredMode = Schema.RequiredMode.REQUIRED)

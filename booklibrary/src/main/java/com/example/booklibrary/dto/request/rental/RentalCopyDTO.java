...
public class RentalCopyDTO {
    ...
    @Schema(description = "ID копии книги", example = "10", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "ID копии книги обязателен")
    @Positive(message = "ID копии книги должно быть положительным числом")
    private Integer copyId;

    @Schema(description = "Срок возврата (дата в будущем)", example = "2025-06-30T23:59:59", requiredMode = Schema.RequiredMode.REQUIRED)
